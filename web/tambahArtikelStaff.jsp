<%-- 
    Document   : tambahArtikelStaff
    Created on : Jul 27, 2018, 1:17:57 PM
    Author     : Andre
--%>
...
<html>
    ...
    <body>
        ...
        <form action="CekTambahArtikelStaff" method="post">
            <table>
                ...
                <tr>
                    <td>Deskripsi</td>
                    <td><textarea name="deskripsi" rows="8" cols="50"></textarea></td>
                </tr>
                <tr>
                    <td>Username</td>
