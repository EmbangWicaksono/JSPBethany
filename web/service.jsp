    ...
    <!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
        ...
        <body>
            ...
            <div class="fh5co-hero">
                ...
                <div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/bg_8.jpg);">
                    <div class="desc">
                        ...
                        <div class="container">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <div class="animate-box">
                                    <h2>SERVICE</h2>
                                    <div class="btn-group">
                                        <a href="RegisterPesan" >Bantuan Doa</a>
                                        <a href="RegisterPelayan" >Daftar Pelayan</a>
                                        <a href="RegisterBabtis" >Daftar Babtis</a>
